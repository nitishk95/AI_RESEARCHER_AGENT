#STEP1:install dependencies and import
from langchain_google_genai import ChatGoogleGenerativeAI
from langgraph.prebuilt import create_react_agent
from arxiv_tool import arxive_search
...
tools=[arxive_search, read_pdf, render_latex_pdf]

model=ChatGoogleGenerativeAI(model="gemini-2.5-pro",api_key=os.getenv("GOOGLE_API_KEY"))

#step3: create the reAct agent 
graph=create_react_agent(model,tools=tools)


#step: run the agenet with initial prompt
INITIAL_PROMPT="""
