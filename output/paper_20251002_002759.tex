...
Our DI-GNN architecture is shown in Figure 1. It consists of a Deformation-Invariant Encoder and a Canonical Shape Decoder.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{placeholder.png}
    \caption{The architecture of our Deformation-Invariant GNN (DI-GNN). The encoder extracts deformation-invariant features from the input point cloud, and the decoder uses these features to reconstruct the object in a canonical, undeformed state.}
...
As you can see, our DI-GNN outperforms the baseline methods by a significant margin. This demonstrates the effectiveness of our approach for non-rigid shape completion. Qualitative results are shown in Figure 2.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{placeholder.png}
    \caption{Qualitative results on the DeformPCN benchmark. Our DI-GNN is able to reconstruct the complete, canonical shape of the object, even when the input is a partial, deformed point cloud.}
